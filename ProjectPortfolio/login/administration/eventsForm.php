...
$database = "slbeyer2_wdv341";
	...
	try 
	{
		...
		$stmt = $conn->prepare("INSERT INTO wedding_event_timeline (event_name, event_description, event_presenter, event_date, event_time) VALUES(:eventName, :eventDescription, :eventPresenter, :eventDate, :eventTime)");
...
?>
<div id="container">
<h1 class="projectTitle">Add Event</h1>
<p>&nbsp;</p>
...
<div id="container">
<h1 class="projectTitle">Add Events</h1>
